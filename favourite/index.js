...
let fav9 = document.getElementById("fav9")
let fav10 = document.getElementById("fav10")
let fav11 = document.getElementById("fav11")
...
fav9.addEventListener('click', (e) =>{
    if(fav9.src.match('/Catalogue/Pictures/Fav_button_nc.png')){
        fav9.src = '/Catalogue/Pictures/Fav_button_c.png'
    }
    else{
        fav9.src = '/Catalogue/Pictures/Fav_button_nc.png'
    }
})

fav10.addEventListener('click', (e) =>{
    if(fav10.src.match('/Catalogue/Pictures/Fav_button_nc.png')){
        fav10.src = '/Catalogue/Pictures/Fav_button_c.png'
    }
    else{
        fav10.src = '/Catalogue/Pictures/Fav_button_nc.png'
    }
})

fav11.addEventListener('click', (e) =>{
    if(fav11.src.match('/Catalogue/Pictures/Fav_button_nc.png')){
        fav11.src = '/Catalogue/Pictures/Fav_button_c.png'
    }
    else{
        fav11.src = '/Catalogue/Pictures/Fav_button_nc.png'
    }
})
